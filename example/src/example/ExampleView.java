...
public class ExampleView extends FrameView {
    ...
    public void showAboutBox() {
        if (aboutBox == null) {
            JFrame mainFrame = ExampleApp.getApplication().getMainFrame();
            aboutBox = new ExampleAboutBox(mainFrame);
            aboutBox.setLocationRelativeTo(mainFrame);
        }
        ExampleApp.getApplication().show(aboutBox);
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(example.ExampleApp.class).getContext().getResourceMap(ExampleView.class);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(example.ExampleApp.class).getContext().getActionMap(ExampleView.class, this);
