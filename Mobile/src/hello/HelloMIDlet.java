...
//GEN-LINE:|7-commandAction|2|26-postAction
    ...
    public Form getForm() {
        if (form == null) {//GEN-END:|14-getter|0|14-preInit
            // write pre-init user code here
            form = new Form("Welcome", new Item[] { getNumber1(), getTextField1(), getTextField2() });//GEN-BEGIN:|14-getter|1|14-postInit
    ...
    //<editor-fold defaultstate="collapsed" desc=" Generated Getter: Number1 ">//GEN-BEGIN:|22-getter|0|22-preInit
    /**
     * Returns an initiliazed instance of Number1 component.
     * @return the initialized component instance
     */
    public TextField getNumber1() {
        if (Number1 == null) {//GEN-END:|22-getter|0|22-preInit
            // write pre-init user code here
            Number1 = new TextField("Number 1", null, 32, TextField.ANY);//GEN-LINE:|22-getter|1|22-postInit
            // write post-init user code here
    ...
    public TextField getTextField1() {
        if (textField1 == null) {//GEN-END:|23-getter|0|23-preInit
            // write pre-init user code here
            textField1 = new TextField("Number 2", null, 32, TextField.ANY);//GEN-LINE:|23-getter|1|23-postInit
            // write post-init user code here
    ...
    public TextField getTextField2() {
        if (textField2 == null) {//GEN-END:|24-getter|0|24-preInit
            // write pre-init user code here
            textField2 = new TextField("Result", null, 32, TextField.ANY);//GEN-LINE:|24-getter|1|24-postInit
            // write post-init user code here
