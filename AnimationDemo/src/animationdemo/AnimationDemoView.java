 ...
 */
public class AnimationDemoView extends FrameView {
    private java.util.Timer timer;
    private Animator array[];
    private int count;
    
    public AnimationDemoView(SingleFrameApplication app) {
        super(app);
    ...
    public void showAboutBox() {
        if (aboutBox == null) {
            JFrame mainFrame = AnimationDemoApp.getApplication().getMainFrame();
            aboutBox = new AnimationDemoAboutBox(mainFrame);
            aboutBox.setLocationRelativeTo(mainFrame);
        }
        AnimationDemoApp.getApplication().show(aboutBox);
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(animationdemo.AnimationDemoApp.class).getContext().getResourceMap(AnimationDemoView.class);
        ...
        stopAnimationButton.setText(resourceMap.getString("stopAnimationButton.text")); // NOI18N
        stopAnimationButton.setName("stopAnimationButton"); // NOI18N
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(animationdemo.AnimationDemoApp.class).getContext().getActionMap(AnimationDemoView.class, this);
...
// TODO add your handling code here:
    if (timer == null) {
        ...
        array = new Animator[10];
        count = 0;
    }
    Color color = new Color((int) (Math.random() * 255),
            (int) (Math.random() * 255),
            (int) (Math.random() * 255));
    Animator animator = new Animator(animationPanel, color);
    timer.schedule(animator, 0, 100);
    array[count++] = animator;
